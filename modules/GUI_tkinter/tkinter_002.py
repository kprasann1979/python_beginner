...
Pillow is a python imaging library (PIL) used for handling images.
We can open, manipulate, save images using this module.
...
right = Image.open("some_date.png") #please change the file path to your directory
right.show()
'''
